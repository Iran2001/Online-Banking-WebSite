    ...
    <div class="container">
        ...
        <div class="transaction-history">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="transaction-type">' .'User :'.$row['name'] . '</div>';
                echo '<div class="transaction-amount">' .'Email :'. $row['email'] .'</div>';
                echo '<div class="transaction-type">' . 'Message :'.$row['massages'] . '</div>';
                echo '</div>';
                echo '<div class="transaction-icon"><i class="fa-solid fa-id-card-clip"></i>';
