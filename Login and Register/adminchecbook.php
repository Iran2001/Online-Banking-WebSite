...
$query = "SELECT * FROM oder_chequebook ";
    ...
    <div class="container">
        ...
        <div class="transaction-history">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="transaction-type">' .'Book Type :'.$row['type'] . '</div>';
                echo '<div class="transaction-amount">' .'Account Number:'. $row['acc_number'] .'</div>';
                echo '<div class="transaction-type">' . 'Leves :'.$row['leves'] . '</div>';
                echo '<div class="transaction-type">' . 'Number Of Books :'.$row['qtybooks'] . '</div>';
                echo '</div>';
                echo '<div class="transaction-icon"> <i class="fa-solid fa-book"></i>';
